...
namespace PhanMem
{
    public partial class ttCongMayInN3 : Form
    {
        ...
        public ttCongMayInN3(string _id_rowindex, qlCongMayInN3 _ql)
        {
            InitializeComponent();
            SetDefault();
            ql = _ql;
        ...
        private string[] GetParam()
        {
            ...
            param[1] = cbThophu.SelectedValue.ToString();
